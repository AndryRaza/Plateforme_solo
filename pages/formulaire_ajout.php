...
<body>
        ...
        <?php if (!($_SESSION['admin'])) { ?>
            <form class="co pt-3" action="scripts/connexion.php" method="POST">
                <div class="form-group d-flex">
                    ...
                    <input type="submit" class="btn btn-primary h-50" name="connexion" id="connexion" value="Se connecter">
                </div>
            </form>
        <?php } else { ?>
            <form class="co" action="scripts/connexion.php" method="POST">
                Mode ADMIN
                <input type="submit" class="btn btn-primary mr-2" name="deconnexion" id="deconnexion" value="Se deconnecter">
            </form>
        <?php }
        ?>
    ...
    <header class="container-fluid bg-dark text-white d-flex align-items-center justify-content-center">
        ...
        <div class="container mt-5">
            <form enctype="multipart/form-data" action="../index.php" method="POST">
                ...
                <div class="form-group d-flex justify-content-end">
                    <input type="submit" class="btn btn-primary " name="add" id="add" value="Valider">
                </div>
            </form>
        </div>
    </section>
